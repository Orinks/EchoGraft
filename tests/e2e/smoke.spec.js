...
test('playable smoke path reaches the restoration atlas systems', async ({ page }) => {
  ...
  await expect(page.getByText(/Packaging and deployment ready: build, preview, packaging checks, Electron directory packaging, dist index, packaged Syngen runtime, and Electron preload\/main files are aligned/)).toBeVisible()
