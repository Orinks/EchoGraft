...
describe('syngen input state', () => {
  ...
  it('normalizes gamepad state into game intents', () => {
    ...
    expect(inputIntentFromSnapshot({ gamepad: { axis: {}, digital: { 6: true, 12: true } }, keyboard: {} })).toEqual({ action: 'objectiveInfo', source: 'gamepad' })
    expect(inputIntentFromSnapshot({ gamepad: { axis: {}, digital: { 6: true, 15: true } }, keyboard: {} })).toEqual({ action: 'positionInfo', source: 'gamepad' })
    expect(inputIntentFromSnapshot({ gamepad: { axis: {}, digital: { 7: true, 13: true } }, keyboard: {} })).toEqual({ action: 'inventoryInfo', source: 'gamepad' })
    expect(inputIntentFromSnapshot({ gamepad: { axis: {}, digital: { 7: true, 14: true } }, keyboard: {} })).toEqual({ action: 'latestLog', source: 'gamepad' })
