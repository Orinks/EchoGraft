content.game = (() => {
  ...
  const chambers = [
    ...
    },
    {
      ...
      directive: 'Repair the intake lung.',
      restoredSystem: 'Intake lung',
    ...
    },
    {
      ...
      objective: 'Tune a seed to the bright third so irrigation can move again.',
    ...
    },
    {
      ...
      directive: 'Stabilize the glass leaves.',
      restoredSystem: 'Canopy lights',
    ...
    },
    {
      ...
      directive: 'Quiet the memory mirror.',
      restoredSystem: 'Memory mirror',
    ...
    },
    {
      ...
      directive: 'Contain the mold pressure lock.',
      restoredSystem: 'Intake pressure lock',
    ...
    },
    {
      ...
      directive: 'Restart the Verdancy Heart.',
      restoredSystem: 'Verdancy Heart',
